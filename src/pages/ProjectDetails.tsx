          ...
          <div className="max-w-7xl mx-auto">
            <Tabs defaultValue="gallery" className="w-full">
              <TabsList className="grid w-full grid-cols-2 md:grid-cols-5 mb-8 h-auto">
                ...
                <TabsTrigger value="content" className="text-xs md:text-sm py-2 px-2 md:px-4">
                  Contenido
                </TabsTrigger>
                <TabsTrigger value="beforeafter" className="text-xs md:text-sm py-2 px-2 md:px-4">
                  {t('beforeAfter')}
                </TabsTrigger>
                <TabsTrigger value="videos" className="text-xs md:text-sm py-2 px-2 md:px-4">
                  Videos
                </TabsTrigger>
